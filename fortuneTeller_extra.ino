...
//display screen if person gets close to touching sensor
void getClose()
{
  lcd.setCursor(2,0);
  lcd.print("I'm getting");
  lcd.setCursor(3,1);
  lcd.print("hungry...");
}
...
void loop() 
{
  ...
  else if(sensorValue>100) //if value is above 500
  {
    lcd.clear();
    getClose(); //display get close message
    lcd.clear();
  }
  
  else //if neither of above statements is true
  {
    lcd.clear();
